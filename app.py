...
st.set_page_config(page_title="PLUTON", layout="wide")
...
if st.session_state.page == "landing":
    ...
    st.markdown(f"<div class='project-title'>PLUTON</div>", unsafe_allow_html=True)
...
if st.session_state.page == "upload":
    st.markdown(
        "<h1 style='color:#d6d6ee; text-align:center; letter-spacing:2px;'>PLUTON</h1>",
        unsafe_allow_html=True
    )
